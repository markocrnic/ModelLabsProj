...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
            ...
            typeIdsInInsertOrder.Add(ModelCode.PLSIMPEDANCE);
			typeIdsInInsertOrder.Add(ModelCode.SERIESCOMP);
			typeIdsInInsertOrder.Add(ModelCode.DCLSEGMENT);
			typeIdsInInsertOrder.Add(ModelCode.ACLSEGMENT);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.PLIMPEDANCE_ACLSEGMENTS);
		}
